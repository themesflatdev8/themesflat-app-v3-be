                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="name" class="form-control" value="{{ $themeItem->name }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="selector_cart_page" class="form-control" value="{{ $themeItem->selector_cart_page }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="position_cart_page" class="form-control" value="{{ $themeItem->position_cart_page }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="style_cart_page" class="form-control" value="{{ $themeItem->style_cart_page }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="selector_cart_drawer" class="form-control" value="{{ $themeItem->selector_cart_drawer }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="position_cart_drawer" class="form-control" value="{{ $themeItem->position_cart_drawer }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="style_cart_drawer" class="form-control" value="{{ $themeItem->style_cart_drawer }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="selector_button_cart_drawer" class="form-control" value="{{ $themeItem->selector_button_cart_drawer }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="selector_wrap_cart_drawer" class="form-control" value="{{ $themeItem->selector_wrap_cart_drawer }}">
                                    </div>
                                </div>
                            </div>
                        </div>
