<x-app-layout>
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('post_affiliate') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="cookie_name" placeholder="Enter cookie name">
                    </div>

                    <div class="mb-3">
                        <label for="timeout" class="form-label">Timeout</label>
                        <input type="number" min="0" class="form-control" name="timeout" placeholder="Enter timeout">
                    </div>

                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <label for="iframe">Iframe <span class="text-danger">*</span></label>
                        ...
                        <div class="iframe-wrapper" id="iframe-wrapper">
                             <div class="iframe-group">
                                <input type="text" class="form-control" name="iframe[]" required placeholder="https://example.com"/>
    ...
    <style>
        ...
        .iframe-group {
            display: flex;
            align-items: center;
            flex: 1 1 calc(50% - 10px); /* Width of each item */
    ...
    <script>
        document.getElementById('add-iframe').addEventListener('click', function() {
            ...
            newIframe.innerHTML = '<input type="text" class="form-control" name="iframe[]" required placeholder="https://example.com"/><button type="button" class="btn btn-danger remove-iframe">X</button>';
