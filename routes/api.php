...
Route::get('/popup', function (Request $request) {
    return response([], 200);
});
Route::get('/crispchat', function (Request $request) {
    return response([], 200);
});
...
Route::group(['prefix' => 'webhook'], function () {
    ...
    Route::post('order/create', [WebhookController::class, 'orderCreate']);
...
Route::group([
    ...
    Route::get('/',  [StoreFrontController::class, 'getBundleStorefront']);
    Route::get('/list-bd',  [StoreFrontController::class, 'getBundleStorefront']);
    Route::get('/list-of',  [StoreFrontController::class, 'getOffer']);
    Route::get('/list-of',  [StoreFrontController::class, 'getOffer']);

    Route::get('/settings-all',  [StoreFrontController::class, 'getSettings']);

    Route::post('/handle-promotion',  [StoreFrontController::class, 'createDiscountCode']);
});
