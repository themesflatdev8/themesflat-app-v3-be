...
if (!function_exists('getDataThemeAppExtension')) {
...
if (!function_exists('getDataAppBlockExtension')) {
...
if (!function_exists('checkLoyalty')) {
...
if (!function_exists('checkTrialTool')) {
...
if (!function_exists('genRandomDiscountNumber')) {
    function genRandomDiscountNumber()
    {
        return  time() . substr(md5(microtime()), rand(0, 26), 2);
    }
}
if (!function_exists('migrateBundleSettings1vs2')) {
